...
async def handle_new_message(event, client):
    logging.info("handle_new_message running")

    message = event.message
    logging.info(f'Got message, text is: {message.message}')
